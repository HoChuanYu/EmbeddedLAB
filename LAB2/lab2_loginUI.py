...
class LoginUI(QWidget):
    ...
    def loginUserInterface(self):
        ...
        # TODO: Connect to self.clickLogin   OK
        ...
        # TODO: Connect to self.createNewUser   OK
    ...
    def clickLogin(self):
        ...
        try:
            with open("files/users.txt", 'r') as f:
                for line in f:
                   (u,r)=line.split() 
                   users[u]=r
                # TODO: parse file and put data in 'users' dict declared above, username as key, password as value  OK
                pass
        ...
        if (username, password) in users.items():
            ...
            # TODO: show a information msg box to tell user that login successful   OK
            self.close()  # close program
        else:
            QMessageBox.question(self, "Error Message",
                                                 "The username or the password is incorrect!",
                                                 QMessageBox.Close, QMessageBox.Close)
            # TODO: show a warning msg box to tell user that username or password incorrect OK
